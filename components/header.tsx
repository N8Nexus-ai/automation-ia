        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-10">
            ...
            <Link href="/sobre" className="font-medium text-base tracking-wider relative group">
              <span className="bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent hover:from-primary hover:to-accent transition-all duration-300">Sobre Nós</span>
              <div className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-primary to-accent transition-all duration-300 group-hover:w-full"></div>
            </Link>
            <Button 
              className="font-bold tracking-wide text-base px-6 py-3 bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border-0"
          ...
          <nav className="md:hidden mt-4 pb-4 border-t border-border pt-4">
            <div className="flex flex-col space-y-6">
              ...
              <Link href="/sobre" className="font-medium text-lg tracking-wider py-3 relative group">
                <span className="bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent hover:from-primary hover:to-accent transition-all duration-300 relative z-10">Sobre Nós</span>
                <div className="absolute left-0 top-0 w-0 h-full bg-primary/10 transition-all duration-300 group-hover:w-full rounded-md"></div>
              </Link>
              <Button 
                className="w-full font-bold tracking-wide text-lg px-6 py-4 bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border-0 mt-4"
                onClick={openContactModal}
              >
                Agendar Conversa
              </Button>
